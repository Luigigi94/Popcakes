...
class EventosController {
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('SELECT * FROM eventos WHERE id_evento = ' + [id], function (err, result, fields) {
                if (err)
                    throw err;
                if (result.length > 0) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE eventos SET ? WHERE id_evento = ' + [id], [req.body]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM eventos WHERE id_evento = ' + [id]);
